...
async def show_game_database(message: Message):
    ...
    fun_messages = [
        "🎮 Volume працює! База ігор тепер зберігає імейджі назавжди! 💾\n\nПоки що знайдіть ігри в розкладі! 🔍",
        "🎲 Успіх! Railway Persistent Storage налаштований! 🚀\n\nАле не сумуйте - всі ігри вже чекають на вас в розкладі! 📅",
        "🎯 Volume активний! Імейджі більше не зникають після деплою! ✅\n\nА поки що - дивіться розклад! 📋",
        "🎪 Перфектно! База ігор навчилася зберігати файли! 🎉\n\nКоли навчиться показувати, обов'язково покаже! А поки що - розклад в дії! 🎭",
        "🎨 Ідеально! Railway Volume працює як годинник! ⚙️\n\nСкоро тут буде купа крутих ігор! А поки що - розклад працює! ✨"
    ]
