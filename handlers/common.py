...
async def show_game_database(message: Message):
    ...
    fun_messages = [
        "🎮 Ой-ой! База ігор зараз вчиться грати в хованки! 🫥\n\nСкоро тут буде купа крутих ігор, а поки що... знайдіть їх в розкладі! 🔍",
        "🎲 Ха! Ця кнопка ще тільки вчиться ходити! 👶\n\nАле не сумуйте - всі ігри вже чекають на вас в розкладі! 📅",
        "🎯 База ігор зараз відпустка на Мальдівах! 🏝️\n\nПовернеться з купою нових ігор, а поки що - дивіться розклад! 📋",
        "🎪 База ігор зараз репетирує цирковий номер! 🤹\n\nКоли навчиться жонглювати іграми, обов'язково покаже! А поки що - розклад в дії! 🎭",
        "🎨 База ігор малює себе красивіше! 🖌️\n\nСкоро буде така гарна, що всі будуть в захваті! А поки що - розклад працює! ✨"
    ]
